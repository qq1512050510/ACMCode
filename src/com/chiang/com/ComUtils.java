 ...
 */
public class ComUtils extends Thread implements SerialPortEventListener {
                    ...
                    while (inputStream.available() > 0) {
                        ...
                        if (numBytes > 0) {
                            msgQueue.add(new Date() + "真实收到的数据为：-----"
                                    + new String(readBuffer, StandardCharsets.UTF_8));
